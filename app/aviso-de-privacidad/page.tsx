...
export default function AvisoDePrivacidad() {
  return (
    <main className="min-h-screen bg-[#F3F5F9] font-sans selection:bg-[#D65F08] selection:text-white py-12 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 p-8 md:p-12 space-y-8 text-slate-700 leading-relaxed text-[15px] animate-slide-up">
          ...
          <section>
            <h2 className="text-xl font-black text-[#D65F08] mb-4 uppercase tracking-widest border-b border-slate-100 pb-2">1. Identidad, Domicilio y Declaración General</h2>
            <p className="mb-4">
            ...
            <p>
              El objetivo rector de esta plataforma gubernamental es fomentar la participación juvenil, el desarrollo económico local y la integración social. La plataforma opera <strong>estrictamente como un canal de intermediación y difusión digital gratuita</strong> entre la juventud escuinapense y el sector comercial privado (negocios aliados).
            </p>
          </section>

          <section>
            <h2 className="text-xl font-black text-[#D65F08] mb-4 uppercase tracking-widest border-b border-slate-100 pb-2">2. Fundamento Legal</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-[#D65F08] mb-4 uppercase tracking-widest border-b border-slate-100 pb-2">3. Datos Recabados y Finalidad (Jóvenes Beneficiarios)</h2>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-xl mb-4 text-slate-800 text-sm font-medium">
          ...
          <section className="bg-orange-50/70 p-6 md:p-8 rounded-[2rem] border border-orange-200 shadow-sm">
            <h2 className="text-xl font-black text-[#D65F08] mb-4 uppercase tracking-widest border-b border-orange-200 pb-2">4. Blindaje Legal y Deslinde de Responsabilidad (Negocios Aliados)</h2>
            ...
            <ul className="list-disc pl-6 space-y-3 font-medium text-orange-900 leading-relaxed">
              <li>
          ...
          <section>
            <h2 className="text-xl font-black text-[#D65F08] mb-4 uppercase tracking-widest border-b border-slate-100 pb-2">5. Transferencia de Datos Personales</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-[#D65F08] mb-4 uppercase tracking-widest border-b border-slate-100 pb-2">6. Ejercicio de Derechos ARCO</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl font-black text-[#D65F08] mb-4 uppercase tracking-widest border-b border-slate-100 pb-2">7. Aceptación Informada</h2>
            <p>
        ...
        <div className="mt-10 text-center pb-8">
          <Link href="/">
            <button className="bg-slate-900 hover:bg-[#D65F08] text-white px-10 py-4 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-xl hover:shadow-2xl transition-all active:scale-95 border border-transparent hover:border-orange-900/50">
              ← Volver al Inicio
            </button>
          </Link>
        </div>
